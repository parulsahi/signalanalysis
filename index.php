...
<br />
<div class="image">
  <a href="#"><img id="myimg" src="images/back.jpg" height:"250px" width="250px" alt="Signals"></a>  
 </div>
<h2 style="font-family:vivaldi;margin-left:300px; margin-right:45px; margin-top:-70px;" align="justify"><b>What is Sigana ?</b></h2>
<h4 align="justify" style="margin-left:300px; margin-right:45px;">
SIGANA is a colaborative initiative by the Department of Computer Science and I.T., University of Jammu and 
Department of Electronics, University of Jammu in providing a platform wherein people from around the world can 
get an understanding about how their body and heart reacts to external stimulus of different kinds.
<br/>
<br/>
 <br/>
 <br/>
...
<ul><li>Before beginning the users are requsted to <a href="signup.php">sign up </a>by filling a simple form and enter the correct choices of the questions
asked in it.</li>
<br/>
<li>After sucessfully signing up, the users can <a href="login.php">login </a>into their account to proceed further.</li>
     </h4>
