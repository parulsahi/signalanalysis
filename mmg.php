...
</nav><!--<div class="logo"><img src="images/logo2cc.png" /></div>-->
...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Mechanomyogram (MMG)</b></h2>
<h4 align="justify" style="margin-left:45px; margin-right:45px;">
The mechanomyogram (MMG) is the mechanical signal observable from the surface of a muscle when 
the muscle is contracted. At the onset of muscle contraction, gross changes in the muscle shape 
cause a large peak in the MMG. Subsequent vibrations are due to oscillations of the muscle fibres 
at the resonance frequency of the muscle. The mechanomyogram is also known as the phonomyogram, 
acoustic myogram, sound myogram, vibromyogram or muscle sound.
 <br/>
 <br/>
  <div class="image">
  <a href="#"><img id="myimg" src="images/mmg.png" height:"400px" width="400px" alt="Recording an MMG Signal"></a>  
 </div>
 <!-- The Modal -->
...
<h4 align="justify" style="margin-left:45px; margin-right:45px;"><b>Measurement Techniques</b><br/><br/>
 It can be measured using an accelerometer or a microphone placed on the skin
  over the belly of the muscle. When measured using a microphone is may be termed the acoustic myogram.

 <br/>
 <br/>
 <h4 align="justify" style="margin-left:45px; margin-right:45px;"><b>Uses of MMG signal</b><br/><br/>
 The MMG may provide a useful alternative to the electromyogram (EMG)
  for monitoring muscle activity. It has a higher signal-to-noise ratio
  than the surface EMG and thus can be used to monitor muscle activity from deeper
   muscles without using invasive measurement techniques. It is currently the subject
    of research activity into prosthetic control and assistive technologies for the disabled.</h4>
