...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Electrooculography (EOG)</b></h2>
...
Electrooculography (EOG) is a technique for measuring the corneo-retinal standing potential
 that exists between the front and the back of the human eye. The resulting signal is called 
 the electrooculogram. Primary applications are in ophthalmological diagnosis and in recording eye movements. 
 ...
 <br/>
  <div class="image">
  <a href="#"><img id="myimg" src="images/eog.png" height:"400px" width="400px" alt="Recording an EOG Signal"></a>  
 </div>
 <!-- The Modal -->
...
<h4 align="justify" style="margin-left:45px; margin-right:45px;"><b>Measurement Techniques</b><br/><br/>
 To measure eye movement, pairs of electrodes are typically placed either above and below the eye or
 to the left and right of the eye. If the eye moves from center position toward one of the two electrodes, 
 this electrode sees the positive side of the retina and the opposite electrode sees the negative side of the retina.
  Consequently, a potential difference occurs between the electrodes. Assuming that the resting potential is constant,
   the recorded potential is a measure of the eye's position.
   <br/>
 <br/>
 <h4 align="justify" style="margin-left:45px; margin-right:45px;"><b>Principle</b><br/><br/>
 The eye acts as a dipole in which the anterior pole is positive and the posterior pole is negative.
<ul><li>
Left gaze: <br/>the cornea approaches the electrode near the outer canthus of the left eye, 
resulting in a negative-trending change in the recorded potential difference.</li>
<li>Right gaze: <br/>the cornea approaches the electrode near the inner canthus of the left eye, 
resulting in a positive-trending change in the recorded potential difference.</li>
</ol>
