...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Modern Medical Instruments</b></h2>
<h4 align="justify" style="margin-left:45px; margin-right:45px;">
Medical devices may sound like a modern invention, 
but they in fact have helped us manage and treat diseases for centuries. Some instruments are:
 <br/>
 <br/>
  <div class="image">
  <a href="#"><img id="myimg" src="images/med.jpg" height:"400px" width="400px" alt="The MelaFind optical scanner from MELA Sciences. "></a>  
 </div>
 <!-- The Modal -->
...
span.onclick = function() { 
 ...
 <ul>
 <li>Clinical Thermometer </li><br/>
 <li>Hypodermic Needle </li><br/>
 <li>Spectacles</li><br/>
 <li>X-Ray Imaging</li><br/>
 <li>Cardiac Pacemaker </li><br/>
 <li>Hearing Aid</li><br/>
 <li>Led Phototherapy</li><br/>
 <li>Prosthetics and Implants</li><br/>
 <li>Drug-Elucting Stent</li><br/>
 <li>Blood Glucose Monitor</li><br/><br/><br/>
