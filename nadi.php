...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Nadi Vigyan</b></h2>
<h4 align="justify" style="margin-left:45px; margin-right:45px;">
Nadi Pariksha is the ancient ayurvedic technique of diagnosis through the pulse. 
...
Nadi Pariksha understands the vibratory frequency of the pulse at various levels on the Radial artery. 
Subtle vibrations are read at seven different levels vertically downward that help in ascertaining various functions in 
the body. The pulse, when examined, reveals both physical & mental characteristics of the patient. 
This is interpreted in the form of symptoms along with their prognosis, which helps in understanding the cause.
 Thus, Nadi Pariksha forms the basis for addressing any ailment in an individual. 

 
 
  <div class="image">
  <a href="#"><img id="myimg" src="images/nadi.jpg" height:"400px" width="400px" alt="Nadi Vigyan"></a>  
 </div>
 <!-- The Modal -->
...
span.onclick = function() { 
 ...
 <br/><br/>
 The time tested and age-old natural way of healing, Ayurveda, has taught that any presence of disease in our
 system will be indicated as an imbalance in our ‘doshas’. The key to cure and keep our body in good health is 
 to balance the doshas and bring back balance to the body system. The principles of Ayurveda follow the natural 
 way to diagnose diseases and bring back balance to the body, and one such mode of diagnosis is ‘nadi pariksha’.

Nadi Pariksha gained its significance during the 17th century in Yogratnakar through 48 shlokas, 
detailing the science of Nadi. The scripture highlights details such as the appropriate time for Nadi Pariksha, 
rules for the Vaidya or Ayurvedic physician as well as the patient and also the rules to be followed before and 
after Nadi Pariksha.

Along with the aforesaid scriptures, many other intellectuals, vaidya and saints did work on the science of Nadi;
 these include Maharishi Kanada, Ravanakrit Nadi Vigyan etc.</h4>
