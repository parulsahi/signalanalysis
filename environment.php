...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Environment</b></h2>
...
The term environment has been derived from a French word “Environia” means to surround.
 It refers to both abiotic (physical or non-living) and biotic (living) environment.
  The word environment means surroundings, in which organisms live. Environment and the organisms 
  are two dynamic and complex component of nature. Environment regulates the life of the organisms
   including human beings. Human beings interact with the environment more vigorously than other living beings. 
   Ordinarily environment refers to the materialsand forces that surrounds the living organism.
 <br/>
 <br/>
  <div class="image">
  <a href="#"><img id="myimg" src="images/env.jpg" height:"400px" width="400px" alt="Environment"></a>  
 </div>
 <!-- The Modal -->
...
<h4 align="justify" style="margin-left:45px; margin-right:45px;"><b> Components of an Environment</b>
<h4 align="justify" style="margin-left:45px; margin-right:45px;">
...
<ul>
<li> 
 Micro environment refers to the immediate local surrounding of the organism</li>

<li>Macro environment refers to all the physical and biotic conditions that surround the organism externally.</li>

<li>Physical environment refers to all abiotic factors or conditions like temperature, light, rainfall, soil, minerals etc. 
It comprises of atmosphere, lithosphere and hydrosphere.</li>

<li>Biotic environment includes all biotic factors or living forms like plants, animals, Micro-organisms.</li>
</ul>
 </h4>
