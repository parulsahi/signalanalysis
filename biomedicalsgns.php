...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Biomedical Signals</b></h2>
...
The biosignals used for medical applications are known as biomedical signals. 
Biosignals may be classified as electric or non-electric. Electrical biosignals, or bioelectrical time signals, 
usually refers to the change in electric current produced by the sum of an electrical potential difference across
 a specialized tissue, organ or cell system. Commonly known bioelectrical signals are:
 <br/>
 <br/>
  <div class="image">
  <a href="#"><img id="myimg" src="images/biosig.jpg" height:"400px" width="400px" alt="Sources of Biomedical Signals"></a>  
 </div>
 <!-- The Modal -->
...
span.onclick = function() { 
 ...
 <ul>
 <li><a href="eeg.php" style="color:black;"> Electroencephalogram (EEG)</a></li><br/>
 <li><a href="ecg.php" style="color:black;"> Electrocardiogram (ECG)</a></li><br/>
 <li><a href="emg.php" style="color:black;"> Electromyogram (EMG)</a></li><br/>
 <li><a href="mmg.php" style="color:black;"> Mechanomyogram (MMG)</a></li><br/>
 <li><a href="eog.php" style="color:black;"> Electrooculography (EOG)</a></li><br/><br/><br/>
 ...
 With the development of methods for remote measurement of electric fields using new sensor technology, 
 electric biosignals such as EEG and ECG can be measured without electric contact with the skin. 
 Non-electric biosignal may refer to any non-electrical signal that is capable of being monitored from biological beings,
    such as mechanical signals (e.g. MMG), acoustic signals (e.g. phonetic and non-phonetic utterances, breathing),
     chemical signals (e.g. pH, oxygenation) and optical signals (e.g. movements).</h4>
