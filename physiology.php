...
<div class="main"> <br />
<br />
<h2 style="font-family:vivaldi;margin-left:45px; margin-right:45px; margin-top:-70px;" align="justify"><b>Physiology</b></h2>
...
It is a sub-section of biology, covering a range of topics that include organs, 
anatomy, cells, biological compounds, and how they all interact to make life possible.
Physiology tests how organs and systems within the body work, how they communicate,
 and how they combine their efforts to make conditions favourable for survival.
 The major systems covered in the study of human physiology are as follows:
 <br/>
 <br/>
  <div class="image">
  <a href="#"><img id="myimg" src="images/phy.jpg" height:"400px" width="400px" alt="Major systems under human physiology"></a>  
 </div>
 <!-- The Modal -->
...
span.onclick = function() { 
 ...
 <ul>
 <li> Circulatory system </li><br/>
 <li> Digestive/excretory system </li><br/>
 <li> Endocrine system </li><br/>
 <li> Immune system </li><br/>
 <li> Musculoskeletal system  </li><br/>
 <li> Integumentary system </li><br/>
 <li> Nervous system  </li><br/>
 <li> Renal/Urinary system </li><br/>
 <li> Reproductive system </li><br/>
 ...
 The disciplines that use the word physiology include:<br/>
 Cell physiology, Evolutionary physiology, Defence physiology, Excercise physiology, Systems physiology etc.
 </h4>
