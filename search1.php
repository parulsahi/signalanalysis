...
$started = microtime(true);
  ...
  $query= "SELECT a.id, a.fname,a.lname,a.ffname,a.mfname,a.dob,  a.gender,
    a.address,a.weight,a.birthplace, a.birthtime,a.maxloc,a.t4,a.t3,a.t5,a.t2,a.sound,a.email,a.image_name,a.signup_date,
               ...
               CONCAT(GROUP_CONCAT(b.aud_name)) aud_name
FROM users a INNER JOIN sound b
ON a.id = b.id
 ...
 $t= 1000000 * ($queryTime);
    ...
    $sound=$row[16];
            ...
            $image_name=$row[18];
             $signup_date=$row[19];
              $aud_name=$row[20];
            $splittedstring=explode(",",$aud_name);
        ...
        <tr><td><b>Birth Place</b></td><td><b> : </b></td><td><?php echo $birthplace; ?></td></tr>
         ...
         <tr><td><b>Colour of your eyes</b></td><td><b> : </b></td><td><?php echo $t3; ?></td></tr>
          ...
          <tr><td><b>Favourite Music</b></td><td><b> : </b></td><td><?php echo $sound; ?></td></tr>
            <tr><td rowspan="1000"><b>Recordings</b></td><td rowspan="1000"><b> : </b></td>
           <?php
